...
class Ellipsoid(Surface):
    ...
    def uv_for_surface_point(self, surface_point):
        ...
        u= np.arctan2(circle_point[1],circle_point[0])
        a = np.cos(u)*circle_point[0]+ np.sin(u)*circle_point[1] 
        v = np.arctan2(a, circle_point[2]) 
...
class Poly_Fit(Surface):
    ...
    def uv_for_surface_point(self, surface_point):
        ...
        a = np.cos(u)*p[0]+ np.sin(u)*p[2] #(cos²(u)*sin(v)+ sin²(u)sin(v) -> (cos²(u) + sin(u)²)sin(v) = 1 sin(v)
        v = np.arctan2(a,  p[1]) 
...
class Thumb_Fit(Poly_Fit):
    ...
    def fV(self, u, v):
        l1 = -1.94746 + 6.36396 *v - 4.26903 *(v**2) + 1.19414 *(v**3) - 0.121014 *(v**4) + 0.770399 * np.sin(u)
        l2 = -0.352104 *v * np.sin(u) - 0.717535 *(v**2)* np.sin(u) + 0.594201 *(v**3)* np.sin(u) - 0.117728 *(v**4)* np.sin(u) 
        l3 = 0.0640809 * np.sin(3 *u) - 0.916533 *v * np.sin(3 *u) + 1.31091 *(v**2)* np.sin(3 *u) - 0.623383 *(v**3)* np.sin(3 *u) 
        l4 = 0.0952166 *(v**4)* np.sin(3 *u) + 0.310284 * np.sin(5 *u) - 0.994679 *v * np.sin(5 *u) + 0.921975 *(v**2)* np.sin(5 *u) 
        l5 = -0.353662 *(v**3)* np.sin(5 *u) + 0.0489974 *(v**4)* np.sin(5 *u) + 0.449265 * np.sin(7 *u) - 1.06284 *v * np.sin(7 *u) 
        l6 = 0.895733 *(v**2)* np.sin(7 *u) - 0.326336 *(v**3)* np.sin(7 *u) + 0.0434835 *(v**4)* np.sin(7 *u)
...
class MF_Fit(Poly_Fit):
    ...
    dispZ = np.array([0, 6, 2])
    c = [7., -12., 24.]
    
    def F(self,u,v):
        fV = self.fV(u,v)
        ellipsoid = np.array([self.c[0]* np.cos(u)* (np.sin(v)**0.5) , self.c[1]*np.sin(u)* (np.sin(v)**0.5) , self.c[2]*(np.cos(v)**0.5)])
        p = self.dispZ + fV*ellipsoid
    ...
    def uv_for_surface_point(self, surface_point):
        ...
        a = np.cos(u)*p[0]+ np.sin(u)*p[1]  
        v = np.arctan2(a**2,  p[2]**2) 
    ...
    def fV(self, u, v):
        ...
        l1 = 1.43065 - 1.37796 *v + 1.8028 *(v**2) - 0.979019 *(v**3) + 0.159354 *(v**4) - 0.221779 *np.sin(u) 
        l2 = 2.06561 *v *np.sin(u) - 3.53071 *(v**2) *np.sin(u) + 2.86204 *(v**3) *np.sin(u) - 0.824104 *(v**4) *np.sin(u) 
        l3 = -0.0713686 *np.sin(3 *u) + 0.406619 *v *np.sin(3 *u) - 0.207328 *(v**2) *np.sin(3 *u) + 0.058279 *(v**3) *np.sin(3 *u) 
        l4 = 0.00962991 *(v**4) *np.sin(3 *u) - 0.00546977 *np.sin(5 *u) - 0.191731 *v *np.sin(5 *u) 
        l5 = 0.909208 *(v**2) *np.sin(5 *u) - 0.972045 *(v**3) *np.sin(5 *u) + 0.320636 *(v**4) *np.sin(5 *u) + 0.00560253 *np.sin(7 *u) 
        l6 = -0.157634 *v *np.sin(7 *u) + 0.551877 *(v**2) *np.sin(7 *u) - 0.547456 *(v**3) *np.sin(7 *u) + 0.170722 *(v**4) *np.sin(7*u)
        res = l1 + l2 + l3+ l4+ l5 +l6 
